import 'package:example_flutter/singleimage.dart';
            ...
            children: <Widget>[
              Padding(
                ...
                child: GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> singleimage(link:  myProfileData['image_dp'],)));
                  },
                                  child: Material( color: Colors.pink,
             ...
             child: ListView.builder(
                   ...
                   itemBuilder: (BuildContext context, int index) {
                     return  Padding(
                       ...
                       child: Material( color: Colors.grey[200],
                        borderRadius: BorderRadius.circular(60.0),
                                      child: Padding( padding: const EdgeInsets.all(3.0),
                                                                          child: Material(
                        color: Colors.white,
                  ...
                  return Padding(
                    ...
                    child: Material(
                      child: Container(
                        ...
                        child: InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>singleimage(link: images[index],)));
                          },
                                                  child: Image.network(
                            images[index],
                          ),
